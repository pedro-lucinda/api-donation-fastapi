...
class InstituteRepository:
    ...
    def create_institute(self, institute_data: CreateInstitute) -> InstituteSchema:
        """
        ...
        """
        user = self.db.query(User).filter(User.id == institute_data.user_id).first()
        if not user:
    ...
    def update_institute(
        ...
        This method updates an institute in the database using the given institute_id and UpdateInstitute schema.
    ...
    def is_admin(self, user_id: int, institute_id: int) -> bool:
        ...
        This method checks if a user is an admin of an institute by checking if the user is present in the institute's
        admins list.
    ...
    def get_admins(self, institute_id: int, user_id: int):
        ...
        This method gets the list of admins of an institute by checking if the user is an admin of the institute and
